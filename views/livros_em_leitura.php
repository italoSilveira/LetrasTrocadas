...
<script type="text/javascript">
	function Abrir(id)
	{
		$.ajax({
			...
			url : "ajax/livros_em_leitura.php?livro="+id,
			dataType : "json",
...
<?php
	...
	{ 
		...
		$pesquisar_livros = new Pesquisar($tabelas,$campos,"tipo = 3 AND usuario_id =".$_SESSION['id']);
		$resultado = $pesquisar_livros->pesquisar();
		
		$pesquisar_quantidade = new Pesquisar($tabelas,"COUNT(id_marcacao) As quantidade"," tipo = 3 AND usuario_id =".$_SESSION['id']);
	...
	<section class="panel panel-default" >
		...
		<section class="panel-body">
				...
				<section class = "col-lg-4">
					...
					<section class = "btn-group" id="botoes">
						...
						<ul id = "acoes" class="dropdown-menu">
							<li><a onClick="AcoesLivro(<?php echo $id_livro[0];?>,'Desmarcar',Resultado,'Lendo');">Desmarcar</a></li>
							<li><a onClick="AcoesLivro(<?php echo $id_livro[0];?>,'QueroLer',Resultado,'Lendo');">Quero Ler</a></li>
							<li><a onClick="AcoesLivro(<?php echo $id_livro[0];?>,'JaLi',Resultado,'Lendo');">Já li</a></li>
						</ul>		
					</section>
				</section>
			...
			<section class="alert alert-dismissable alert-info">
				<strong>Você não adicionou nenhum livro a sua estante de livros em leitura! Para adicionar é só pesquisar o livro, ir no botão "Eu..." e clicar em "Estou Lendo"!</strong>
			</section>
			<?php
				}
			?>			   
